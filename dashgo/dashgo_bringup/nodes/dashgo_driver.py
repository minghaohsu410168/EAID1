...
class BaseController:
    def __init__(self, arduino, base_frame):
        ...
        self.lEncoderPub = rospy.Publisher('Lencoder', Int16, queue_size=10)
        self.rEncoderPub = rospy.Publisher('Rencoder', Int16, queue_size=10)
        self.lPidoutPub = rospy.Publisher('Lpidout', Int16, queue_size=10)
        self.rPidoutPub = rospy.Publisher('Rpidout', Int16, queue_size=10)
        self.lVelPub = rospy.Publisher('Lvel', Int16, queue_size=10)
        self.rVelPub = rospy.Publisher('Rvel', Int16, queue_size=10)
